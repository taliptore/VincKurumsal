...
const FormWizard = function() {
    ...
    const _componentWizard = function() {
        ...
        $('.steps-basic').steps({
            ...
            labels: {
                previous: document.dir == 'rtl' ? '<i class="ph-arrow-circle-right me-2"></i> Geri' : '<i class="ph-arrow-circle-left me-2"></i> Geri',
                next: document.dir == 'rtl' ? 'Ýleri <i class="ph-arrow-circle-left ms-2"></i>' : 'Ýler <i class="ph-arrow-circle-right ms-2"></i>',
                finish: 'Submit form <i class="ph-paper-plane-tilt ms-2"></i>'
            },
            onFinished: function (event, currentIndex) {
                alert('Form 55 submitted.');
            }
        });
        ...
        validationExampleElement.steps({
            ...
            labels: {
                previous: document.dir == 'rtl' ? '<i class="ph-arrow-circle-right me-2"></i> Geri' : '<i class="ph-arrow-circle-left me-2"></i> Geri',
                next: document.dir == 'rtl' ? 'ileri <i class="ph-arrow-circle-left ms-2"></i>' : 'ileri <i class="ph-arrow-circle-right ms-2"></i>',
                finish: 'Kaydet <i class="ph-paper-plane-tilt ms-2"></i>'
            },
            transitionEffect: 'fade',
            autoFocus: true,
