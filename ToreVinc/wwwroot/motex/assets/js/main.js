...
(function ($) {
	...
	if($(".price-range").length){
        $( ".price-range" ).slider({
            ...
            slide: function( event, ui ){$( "#price-amount" ).val(  ui.values[ 0 ] + " TL - " + ui.values[ 1 ] +" TL" );}
        });
        $( "#price-amount" ).val(  $( ".price-range" ).slider( "values", 0 ) + " TL - " + $( ".price-range" ).slider( "values", 1 )+" TL" );
    }
    if ($(".km-range").length) {
        $(".km-range").slider({
            range: true,
            ...
            max: 750000,
            values: [0, 750000],
            slide: function (event, ui) { $("#km-amount").val(ui.values[0] + " KM - " + ui.values[1] + " KM"); }
        });
        $("#km-amount").val($(".km-range").slider("values", 0) + " KM - " + $(".km-range").slider("values", 1) + " KM");
    }
