...
namespace KurumsalWebVinc.Migrations
{
    ...
    [Migration("20230329133431_aracyil")]
    partial class aracyil
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KurumsalWebVinc.Models.AracBilgisi", b =>
                {
                    ...
                    b.HasOne("KurumsalWebVinc.Models.ModelArac.MotorGucu", "MotorGucu")
                        .WithMany("AracBilgisis")
                        .HasForeignKey("MotorGucuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
