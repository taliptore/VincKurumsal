...
namespace KurumsalWebVinc.Migrations
{
    ...
    [Migration("20230227064312_addtablohakhizmet")]
    partial class addtablohakhizmet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KurumsalWebVinc.Models.Culture", b =>
                {
            ...
            modelBuilder.Entity("KurumsalWebVinc.Models.Localization", b =>
                {
                    b.Property<int>("LocalizationSetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LocalizationSetId"));

                    b.Property<string>("CultureCode")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("LocalizationSetId1")
                        .HasColumnType("int");

                    b.Property<string>("Value")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("LocalizationSetId");

                    b.HasIndex("CultureCode");

                    b.HasIndex("LocalizationSetId1");

                    b.ToTable("Localization");
                });

            modelBuilder.Entity("KurumsalWebVinc.Models.LocalizationSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KurumsalWebVinc.Models.Localization", b =>
                {
                    b.HasOne("KurumsalWebVinc.Models.Culture", "Culture")
                        .WithMany()
                        .HasForeignKey("CultureCode");

                    b.HasOne("KurumsalWebVinc.Models.LocalizationSet", "LocalizationSet")
                        .WithMany("Localizations")
                        .HasForeignKey("LocalizationSetId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KurumsalWebVinc.Models.Menu", b =>
                {
                    b.HasOne("KurumsalWebVinc.Models.AltMenu", "AltMenu")
                        .WithMany("Menus")
                        .HasForeignKey("AltMenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KurumsalWebVinc.Models.LocalizationSet", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId");

                    b.HasOne("KurumsalWebVinc.Models.LocalizationSet", "Description")
                        .WithMany()
                        .HasForeignKey("DescriptionId");

                    b.HasOne("KurumsalWebVinc.Models.LocalizationSet", "Name")
                        .WithMany()
